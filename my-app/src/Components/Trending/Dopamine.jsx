...
const Dopamine = () => {
  ...
  const dopamineProducts = allProducts.filter(
    (product) => Array.isArray(product.trending) && product.trending.includes("Dopamine")
  );
  ...
  const applyFilters = () => {
    return dopamineProducts.filter((product) => {
      // Filter by Type
  ...
  return (
    <div className="material-page">
      ...
      <p className="material-description">
        Discover our beautiful collection of dopamine trend products, crafted with elegance and durability.
      </p>
      {isMobile && (
