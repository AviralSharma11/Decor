...
const Vintage = () => {
  ...
  const vintageProducts = allProducts.filter((product) => product.style === "Vintage");
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Vintage Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of vintage style products, crafted with elegance and durability.
      </p>
      {isMobile && (
