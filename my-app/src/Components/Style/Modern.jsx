...
const Modern = () => {
  ...
  const modernProducts = allProducts.filter(
    (product) => Array.isArray(product.style) && product.style.includes("Modern")
  );
  ...
  const applyFilters = () => {
    return modernProducts.filter((product) => {
      // Filter by Type
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Modern Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of modern style products, crafted with elegance and durability.
      </p>
      {isMobile && (
