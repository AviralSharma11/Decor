...
const Bohemian = () => {
  ...
  const bohemianProducts = allProducts.filter((product) => product.style === "Bohemian");
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Bohemian Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of bohemian style products, crafted with elegance and durability.
      </p>
      {isMobile && (
