...
const Wellness = () => {
        ...
        return localStorage.getItem("isAuthenticated") === "true"; // Check login status
          ...
          const [user, setUser] = useState(() => {
            ...
            useEffect(() => {
              ...
              useEffect(() => {
                fetch("http://localhost:5000/api/products/theme/Wellness")
                  .then((res) => res.json())
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Wellness Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of wellness themed products, crafted with elegance and durability.
      </p>
      {isMobile && (
