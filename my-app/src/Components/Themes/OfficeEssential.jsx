...
const OfficeEssential = () => {
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Office Essential Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of office essential themed products, crafted with elegance and durability.
      </p>
      {isMobile && (
...
export default OfficeEssential;
