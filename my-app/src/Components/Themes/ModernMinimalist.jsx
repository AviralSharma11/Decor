...
const ModernMinimalist = () => {
  ...
  const modernMinimalistProducts = allProducts.filter(
    (product) => Array.isArray(product.theme) && product.theme.includes("Modern Minimalist")
  );
  ...
  const applyFilters = () => {
    return modernMinimalistProducts.filter((product) => {
      // Filter by Type
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Modern Minimalist Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of modern minimalist themed products, crafted with elegance and durability.
      </p>
      {isMobile && (
