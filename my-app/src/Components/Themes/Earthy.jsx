...
const Earthy = () => {
  ...
  const earthyProducts = allProducts.filter(
    (product) => Array.isArray(product.theme) && product.theme.includes("Earthy")
  );
  ...
  const applyFilters = () => {
    return earthyProducts.filter((product) => {
      // Filter by Type
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Earthy Collection</h2>
      <p className="material-description">
        Discover our beautiful collection of earthy themed products, crafted with elegance and durability.
      </p>
      {isMobile && (
