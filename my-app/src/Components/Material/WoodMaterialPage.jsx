...
const WoodMaterialPage = () => {
 ...
 const [isMobile, setIsMobile] = useState(window.innerWidth <= 768);
  ...
  const applyFilters = () => {
    const woodProducts = allProducts.filter(
      (product) => product.material && product.material.toLowerCase() === "wood"
    );

    return woodProducts.filter((product) => {
      // Type
  ...
  return (
    <div className="material-page">
      ...
      <h2 className="material-heading">Wood Collection</h2>
