...
export default function Style(){
  ...
  useEffect(() => {
    ...
    const material = [
        { name: "TRADITIONAL", image: "/Images/bytrend.jpg", link: "/style/traditional"},
        { name: "MODERN", image: "/Images/bystyles.jpg", link: "/style/modern"},
        { name: "TRANSITIONAL", image: "/Images/bymaterial.jpg", link: "/style/transitional" },
        { name: "BOHEMIAN", image: "/Images/bythemes.jpg" , link: "/style/bohemian" },
        { name: "VINTAGE", image: "/Images/bythemes.jpg", link: "/style/vintage"}
      ];
    return(
        <div className="material">
            ...
            <div className="carousel-container">
                ...
                <nav className="breadcrumb">
                    ...
                    <Link to="/collections/style"> <strong>Shop By Style</strong></Link>
                </nav>
