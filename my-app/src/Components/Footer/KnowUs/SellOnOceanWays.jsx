    ...
    <>
      ...
      <div className="sell-container">
        ...
        <p className="subheading">
          Interior Designers and Entrepreneurs who frequently sell home decor,
          furniture, or curated lifestyle products can apply to collaborate with OceanWays.
        </p>
        ...
        <section className="about-section">
          ...
          <p>
            We’re here to help you grow your business with exclusive benefits, insights,
            and personalized support from our team. Join our Sell on OceanWays initiative
